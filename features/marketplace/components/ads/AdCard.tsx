...
const AdCard: React.FC<AdCardProps> = ({ 
  ...
  const cardContainerClass = `
      bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1 flex flex-col ${cardMainClass}
